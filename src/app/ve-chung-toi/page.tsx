      ...
      <div className="relative max-w-7xl mx-auto py-24 px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl lg:text-5xl">
            Về The Wellington Offices
          </h2>
          <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-500">
            Đối tác tin cậy của bạn trong lĩnh vực không gian làm việc linh hoạt và hiệu quả.
          </p>
        </div>
          ...
          <div className="relative max-w-4xl mx-auto bg-white rounded-lg shadow-xl overflow-hidden">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
              <div className="px-8 py-12 text-center">
                <h3 className="text-3xl font-bold text-white mb-4">Sứ mệnh của chúng tôi</h3>
                <p className="mt-2 text-xl text-gray-300 leading-relaxed">
                  Mang đến không gian làm việc lý tưởng, hỗ trợ sự phát triển bền vững cho mọi doanh nghiệp. Chúng tôi cam kết cung cấp dịch vụ tận tâm và giải pháp tối ưu nhất.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative max-w-4xl mx-auto bg-white rounded-lg shadow-xl overflow-hidden">
            <div className="px-8 py-10">
              ...
              <p className="mt-2 text-lg text-gray-600 leading-relaxed">
                Đội ngũ The Wellington Offices là tập hợp những chuyên gia giàu kinh nghiệm và nhiệt huyết trong lĩnh vực bất động sản thương mại. Chúng tôi luôn nỗ lực để hiểu rõ nhu cầu của khách hàng và cung cấp những giải pháp phù hợp nhất.
              </p>
